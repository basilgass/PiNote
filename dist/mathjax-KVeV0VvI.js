import { t as e } from "./pi-note.js";
import { t } from "./PrioritizedList-OKfur1cD.js";
//#region node_modules/@mathjax/src/mjs/components/version.js
var n = "4.1.1", r = class extends t {
	register(e) {
...
//#endregion
//#region node_modules/@mathjax/src/mjs/util/Retries.js
function i(e) {
...
//#endregion
//#region node_modules/@mathjax/src/mjs/util/context.js
var o = typeof window < "u", s = {
	window: o ? window : null,
	document: o ? window.document : null,
	os: (() => {
...
s.os === "Windows" && (s.path = (e) => e.match(/^[/\\]?[a-zA-Z]:[/\\]/) ? "file://" + e.replace(/\\/g, "/").replace(/^\//, "") : e.replace(/^\//, "file:///"));
//#endregion
//#region node_modules/@mathjax/src/mjs/mathjax.js
var c = /* @__PURE__ */ e({ mathjax: () => l }), l = {
	version: n,
	context: s,
	handlers: new r(),
	document: function(e, t) {
		return l.handlers.document(e, t);
	},
	handleRetriesFor: i,
	retryAfter: a,
	asyncLoad: null,
...
//#endregion
export { a, i, c as n, s as r, l as t };
